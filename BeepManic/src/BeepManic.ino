...
int melody[] = {NOTE_E5,NOTE_E5,0,NOTE_E5,0,NOTE_C5,NOTE_E5,0,NOTE_G5,0,0,NOTE_G4}; //mario theme
...
int noteDurations[] = {4,4,4,4,4,4,4,4,4,2,4,4}; //mario theme
...
void letMeGo(){
 ...
 for (int thisNote = 0; thisNote < (sizeof(letGoMelody)/sizeof(int)); thisNote++) {
  ...
  int noteDuration = 60*1000/BPM/letGoMelodyDurations[thisNote];
